...
const inheritanceTable: { [key: string]: string[] } = {
  ...
  'St.GenericAccessible': ['St.WidgetAccessible', 'Atk.Action', 'Atk.Component', 'Atk.Value', 'Cally.Actor'],
  'St.Icon': [
    'St.Widget',
    'Atk.ImplementorIface',
    'Clutter.Animatable',
  ...
  'St.ImageContent': ['Clutter.Image', 'Clutter.Content', 'Gio.Icon', 'Gio.LoadableIcon'],
  'St.Label': [
    'St.Widget',
    'Atk.ImplementorIface',
    'Clutter.Animatable',
  ...
  'St.ScrollViewFade': ['Clutter.ShaderEffect'],
  ...
  'St.WidgetAccessible': ['Cally.Actor', 'Atk.Action', 'Atk.Component'],
  'Shell.App': ['GObject.Object'],
  'Shell.AppSystem': ['GObject.Object'],
  'Shell.AppUsage': ['GObject.Object'],
  'Shell.BlurEffect': ['Clutter.Effect'],
  ...
  'Shell.GLSLEffect': ['Clutter.OffscreenEffect'],
  ...
  'Shell.InvertLightnessEffect': ['Clutter.OffscreenEffect'],
  ...
  'Shell.SecureTextBuffer': ['Clutter.TextBuffer'],
  'Shell.SquareBin': [
    'St.Bin',
    'Atk.ImplementorIface',
    'Clutter.Animatable',
  ...
  'Shell.WindowPreviewLayout': ['Clutter.LayoutManager'],
