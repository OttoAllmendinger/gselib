...
import * as CoglPango from './CoglPango-7';
import * as PangoCairo from './PangoCairo-1.0';
import * as Pango from './Pango-1.0';
import * as HarfBuzz from './HarfBuzz-0.0';
import * as Cogl from './Cogl-7';
...
export abstract class ActorClass {
    ...
    queue_redraw: (actor: Actor, leaf_that_queued: Actor, paint_volume: PaintVolume) => boolean
...
export abstract class EffectClass {
    ...
    pre_paint: (effect: Effect, paint_context: PaintContext) => boolean
    post_paint: (effect: Effect, paint_context: PaintContext) => void
    modify_paint_volume: (effect: Effect, volume: PaintVolume) => boolean
    paint: (effect: Effect, paint_context: PaintContext, flags: EffectPaintFlags) => void
...
export abstract class InputDeviceClass {
    ...
    parent_class: GObject.ObjectClass
    keycode_to_evdev: (device: InputDevice, hardware_keycode: number, evdev_keycode: number) => boolean
    update_from_tool: (device: InputDevice, tool: InputDeviceTool) => void
...
export abstract class KeymapClass {
    ...
    parent_class: GObject.ObjectClass
    get_num_lock_state: (keymap: Keymap) => boolean
    get_caps_lock_state: (keymap: Keymap) => boolean
...
export abstract class OffscreenEffectClass {
    ...
    paint_target: (effect: OffscreenEffect, paint_context: PaintContext) => void
    static name: string
}
...
export abstract class SeatClass {
    ...
    compress_motion: (seat: Seat, event: Event, to_discard: Event) => void
    handle_device_event: (seat: Seat, event: Event) => boolean
    warp_pointer: (seat: Seat, x: number, y: number) => void
    copy_event_data: (seat: Seat, src: Event, dest: Event) => void
    free_event_data: (seat: Seat, event: Event) => void
    apply_kbd_a11y_settings: (seat: Seat, settings: KbdA11ySettings) => void
...
export abstract class StageViewClass {
    ...
    get_offscreen_transformation_matrix: (view: StageView, matrix: Cogl.Matrix) => void
