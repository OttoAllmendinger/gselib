...
const inheritanceTable: { [key: string]: string[] } = {
  ...
  'Gtk.FileFilter': ['Gtk.Filter', 'Gtk.Buildable', 'GObject.Object'],
  ...
  'Gdk.GLContext': ['Gdk.DrawContext', 'GObject.Object'],
  ...
  'Gsk.NglRenderer': ['Gsk.Renderer', 'GObject.Object'],
