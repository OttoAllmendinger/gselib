...
export class WebsocketExtension {
    ...
    process_incoming_message(header: number, payload: Gjs.byteArray.ByteArray): [ /* returnType */ Gjs.byteArray.ByteArray, /* header */ number ]
    process_outgoing_message(header: number, payload: Gjs.byteArray.ByteArray): [ /* returnType */ Gjs.byteArray.ByteArray, /* header */ number ]
    /* Methods of GObject.Object */
    bind_property(source_property: string, target: GObject.Object, target_property: string, flags: GObject.BindingFlags): GObject.Binding
    bind_property_full(source_property: string, target: GObject.Object, target_property: string, flags: GObject.BindingFlags, transform_to: GObject.Closure, transform_from: GObject.Closure): GObject.Binding
    force_floating(): void
    ...
    vfunc_process_incoming_message(header: number, payload: Gjs.byteArray.ByteArray): [ /* returnType */ Gjs.byteArray.ByteArray, /* header */ number ]
    vfunc_process_outgoing_message(header: number, payload: Gjs.byteArray.ByteArray): [ /* returnType */ Gjs.byteArray.ByteArray, /* header */ number ]
    /* Virtual methods of GObject.Object */
    vfunc_constructed(): void
    vfunc_dispatch_properties_changed(n_pspecs: number, pspecs: GObject.ParamSpec): void
    vfunc_dispose(): void
