...
export function base64_decode_inplace(text: Gjs.byteArray.ByteArray): [ /* returnType */ number, /* text */ Gjs.byteArray.ByteArray ]
export function base64_encode(data: Gjs.byteArray.ByteArray | null): string
export function base64_encode_close(break_lines: boolean, state: number, save: number): [ /* returnType */ number, /* out */ Gjs.byteArray.ByteArray, /* state */ number, /* save */ number ]
export function base64_encode_step(in_: Gjs.byteArray.ByteArray, break_lines: boolean, state: number, save: number): [ /* returnType */ number, /* out */ Gjs.byteArray.ByteArray, /* state */ number, /* save */ number ]
